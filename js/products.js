/* products.js
   - Carrega catálogo de produtos de forma estática para funcionamento offline.
*/

window.NEGO_PRODUCTS = {
  _cache: null,

  // Os dados dos produtos agora estão diretamente no código
  _data: [
    {
      "id": "brasil-1970",
      "code": "BR1970",
  ...
  // A função load agora retorna os dados diretamente, sem fetch.
  async load() {
